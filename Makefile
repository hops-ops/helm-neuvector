...
PACKAGE ?= helm-neuvector
XRD_DIR := apis/neuvectors
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/neuvectors/standard.yaml
...
EXAMPLES := \
    examples/neuvectors/minimal.yaml:: \
    examples/neuvectors/standard.yaml::
...
render\:%:
	@example="examples/neuvectors/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
